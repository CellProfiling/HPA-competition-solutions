...
df_1 =  expand('subs/en12a_original_4.8_leak.csv')
df_2 =  expand( 'sub_dir_team/GAPNET blend_13_ext_13_ext5crop_stacked_lb_prob_freq.csv')  # replaced with previous 0.580
df_3 =  expand('sub_dir_team/ens85bd_russ_616.csv')
df_4 =  expand('subs/ens103a_external_leak.csv')
...
df_8 =  expand('sub_dir_team/GAPNET blend_13_ext6040_13_ext5crop_stacked_650_freq.csv') # replaced with previous 0.602
...
submit.to_csv('sub_dir_team/enstw39b1a.csv', index=False)
