...
#
# tb_logger = TensorboardLogger(learner.model, md, "resxt101_512_unbalanced_ext_4chn_5050", metrics_names=["precision", 'recall', 'f1'])
#
# lr = 1e-3
# #learner.fit(lr,1)
#
...
# # =======================================================================================================================
# learner.unfreeze()
#learner.load('ResNetXt101_512_4-swa')
#learner.fit(lrs / 4, 4, cycle_len=2, use_clr=(10, 20), cycle_save_name='resxt101_512_ext_4chn_5050_1', callbacks=[tb_logger])
#learner.fit(lrs / 4, 2, cycle_len=4, use_clr=(10, 20), cycle_save_name='resxt101_512_ext_4chn_5050_2', callbacks=[tb_logger])

#learner.load('resxt101_512_ext_4chn_5050_2_cyc_1')
#learner.fit(lrs / 16, 1, cycle_len=8, use_clr=(5, 20), cycle_save_name='resxt101_512_ext_4chn_5050_3',use_swa=True, swa_start=1, callbacks=[tb_logger])

# =======================================================================================================================
# Submission
# =======================================================================================================================

models = ['resxt101_512_ext_4chn_5050_2_cyc_1', 'resxt101_512_ext_4chn_5050_3_cyc_0-swa']
#=======================================================================================================================
# Bagging
########################################################################################################################
