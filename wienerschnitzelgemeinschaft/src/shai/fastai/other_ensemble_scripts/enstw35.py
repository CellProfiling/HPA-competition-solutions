...
#=======================================================================================================================
sum = df_1[:, 1:]*1 + df_2[:, 1:]*3 + df_3[:, 1:]*3 + df_4[:, 1:]*2 + df_5[:, 1:]*3 + df_6[:, 1:]*2
...
submit.to_csv('sub_dir_team/enstw35_1shai562_3russ616_3dieter612_2shai593_3dmytro617_2kevin602_7.14_clswt.csv', index=False)
