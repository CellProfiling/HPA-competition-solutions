...
# Read submits
#====================================================================================================================
df_1 =  expand('sub1.csv')
df_2 =  expand('sub2.csv')
df_3 =  expand('sub3.csv')
df_4 =  expand('sub4.csv')
df_5 =  expand('sub5.csv')
df_6 =  expand('sub6.csv')
df_7 =  expand('sub7.csv')
...
submit.to_csv('voted_sub.csv', index=False)
