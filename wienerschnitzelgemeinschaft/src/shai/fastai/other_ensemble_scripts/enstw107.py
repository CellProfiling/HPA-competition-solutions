...
# Manual thresholds
th_m = np.array([th+0.05, th,   th+0.05,   th,  th,   th,   th,   th,   th-0.1,   th-0.1,
                 th-0.1,  th,   th,   th,   th,   th-0.15,   th,   th+0.05,   th,   th,
                 th,  th+0.05,  th,   th,   th,   th+0.05,  th,   th-0.14])
...
save_pred(sub_avg, ths = th_m, fname = 'sub_dir_team/ensemble-v4.csv'.format(th))  # From manual threshold
...
sub_dir = 'subs/'
df_1 =  expand('sub_dir_team/ensemble-v4.csv'.format(th)) #497
