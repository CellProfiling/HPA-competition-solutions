...
df_2 =  expand( 'sub_dir_team/GAPNET blend_13_ext_13_ext5crop_stacked_lb_prob_freq.csv') # replaced 0.580 0ne
...
#=======================================================================================================================
sim = df_1*1 + df_2*1 + df_3*1 + df_4*1 + df_5*1 + df_6*1 ++ df_7*1
sim = sim[:, 1:]
unique, counts = np.unique(sim, return_counts=True)
#=======================================================================================================================
sum = df_1[:, 1:]*1 + df_2[:, 1:]*3 + df_3[:, 1:]*3 + df_4[:, 1:]*2 + df_5[:, 1:]*3 + df_6[:, 1:]*2 + + df_7[:, 1:]*1
...
submit.to_csv('sub_dir_team/enstw36b_1shai562_3russ616_3dieter580up_2shai593_3dmytro617_2kevin602_1l2615_7.15_clswt.csv', index=False)
