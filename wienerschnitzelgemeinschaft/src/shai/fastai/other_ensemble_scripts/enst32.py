...
df_3 =  expand(sub_dir + 'ens85bd_616.csv') # 0.616
...
df_6 =  expand(sub_dir +'voted_5_d_602.csv') #0.602
...
#===============================
sum = df_1[:, 1:]*1 + df_2[:, 1:]*1 + df_3[:, 1:]*2 + df_4[:, 1:]*1 + df_5[:, 1:]*1 ++ df_6[:, 1:]*1
...
submit.to_csv('sub_dir_team/enst32_1shai562_2russ616_1dieter580_1shai593_1dmytro592_kevin602_3.7.csv', index=False)
