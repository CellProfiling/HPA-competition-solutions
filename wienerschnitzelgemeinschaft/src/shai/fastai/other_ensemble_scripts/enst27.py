...
df_4 =  expand(sub_dir +'ens21_res50xt+res34_extra_4.10_leak_592.csv') #0.592
df_5 =  expand(sub_dir +'sub37_dpn68_gwap_extra_01_30_592.csv') #0.592
df_6 =  expand(sub_dir +'voted_5_d_602.csv') #0.593
...
submit.to_csv('sub_dir_team/enst27_1shai562_1russ609_1dieter580_1shai592_1dmytro592_kevin602_3.6.csv', index=False)
