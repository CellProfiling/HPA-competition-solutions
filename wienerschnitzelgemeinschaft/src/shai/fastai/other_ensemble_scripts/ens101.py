...
subs = ['res34_512_ext_3chn_4_cyc_0_cp1',
        'res34_512_ext_3chn_5_cyc_0-swa_cp2',
...
save_pred(sub_avg, th = th, fname = 'sub_dir_team/enspreds101_res34-50_th{}.csv'.format(th))  # From manual threshold
...
sub_dir = 'subs/'
df_1 =  expand('sub_dir_team/enspreds101_res34-50_th{}.csv'.format(th)) #497
