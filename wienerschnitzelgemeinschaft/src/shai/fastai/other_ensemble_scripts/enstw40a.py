...
df_2 =  expand('sub_dir_team/submission_blend1_dieter_612.csv')
...
df_8 =  expand('sub_dir_team/Christof_blend_4_580.csv')
df_9 =  expand('sub_dir_team/sub42_ensemble_dmytro_598.csv')

#=======================================================================================================================
# Visualize distribution
#=======================================================================================================================
list =[0,1,2,3,4,5,6,7,8,]
colors = ['r', 'g', 'b', 'c', 'm', 'y', 'k', 'orange', 'cyan']
w=0
for i in list:
    x = np.arange(0, 28, 1)
...
#=======================================================================================================================
sim = df_1*1 + df_2*1 + df_3*1 + df_4*1 + df_5*1 + df_6*1 + df_7*1 + df_8*1 + df_9*1
sim = sim[:, 1:]
...
vote_sub0  = np.where(sum[:,0]  >= vote+5,    1, 0)      #high
...
vote_sub25 = np.where(sum[:,25] >= vote+2,    1, 0)      #high
...
submit.to_csv('sub_dir_team/enstw40a_2sh562_2ru616_2die602_2sh593_3dm627_2ke602_1l2.615updt_1die580_1dm598_8.16_clswt.csv', index=False)
