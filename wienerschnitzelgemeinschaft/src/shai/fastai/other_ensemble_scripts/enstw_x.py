...
df_3 =  expand('sub_dir_team/enspreds103_12mdl_512-256_wtth0.45_leak_shai_593.csv')
...
#=======================================================================================================================
sum = df_1[:, 1:]*1 + df_2[:, 1:]*2 + df_3[:, 1:]*2
...
submit.to_csv('sub_dir_team/ensemble-v4.csv', index=False)
