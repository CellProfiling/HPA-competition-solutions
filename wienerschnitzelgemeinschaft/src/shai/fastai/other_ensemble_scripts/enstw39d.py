...
vote_sub0  = np.where(sum[:,0]  >= vote+2,  1, 0)      #high
...
submit.to_csv('sub_dir_team/enstw39d_low-2_high+2_1sh562_3ru616_2die580_2sh593_3dm627_2ke602_1l2.615updt_2die602_8.16_clswt.csv', index=False)
