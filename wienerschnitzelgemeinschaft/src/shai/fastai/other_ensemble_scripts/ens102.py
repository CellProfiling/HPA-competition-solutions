...
subs = ['501_res34_512_ext_3chn_4_cyc_0_cp1',
        '502_res34_512_ext_3chn_5_cyc_0-swa_cp2',

        '601_resxt50_512_ext_2_cyc_1_cp1',
        '602_resxt50_512_ext_3_cyc_0_cp2',
        '603_resxt50_512_ext_4_cyc_0-swa_cp3'
        ]
...
save_pred(sub_avg, th = th, fname = 'sub_dir_team/enspreds102_res34-50_th{}.csv'.format(th))  # From manual threshold
...
sub_dir = 'subs/'
df_1 =  expand('sub_dir_team/enspreds102_res34-50_th{}.csv'.format(th)) #497
df_2 =  expand('sub_dir_team/enst1.8_1shai562_1russ600_1dieter_2.3.csv'.format(th))
list =[0,1]
for i in list:
    x = np.arange(0, 28, 1)
