...
raw_train_df.to_csv('../input/train_fld1.csv')
valid_df.to_csv('../input/valid_fld1.csv')
...
# tb_logger = TensorboardLogger(learner.model, md, "wrn_512_val3", metrics_names=["precision", 'recall', 'f1'])
# lr = 1e-3
# lrs=np.array([lr/10,lr/3,lr])
#
#
# #learner.fit(lr,1, best_save_name='wrn_512_0.3', callbacks=[tb_logger])
# learner.unfreeze()
# # learner.load('wrn_512_3.3')
# #learner.fit(lrs/4,4,cycle_len=2,use_clr=(10,20),best_save_name='wrn_512_1.3', callbacks=[tb_logger])
# #learner.fit(lrs/4,2,cycle_len=4,use_clr=(10,20), best_save_name='wrn_512_2.3', callbacks=[tb_logger])
# #learner.fit(lrs/16,1,cycle_len=8,use_clr=(5,20), best_save_name='wrn_512_3.3', callbacks=[tb_logger])
...
# # learner.save('wrn_512_unbalanced')
#
# learner.load('wrn_512_unbalanced')
# #learner.load('wrn_512_balanced')
# #learner.fit(lrs/16,1,cycle_len=8,use_clr=(5,20), callbacks=[tb_logger] )
# #learner.fit(lrs/16,1,cycle_len=8,use_clr=(5,20), callbacks=[tb_logger])
# #learner.save('wrn_512_unbalanced_grn+')
#
# # swa
...
# learner.fit(lrs/16, n_cycle=6, cycle_len=4,use_clr=(5,20), use_swa=True, swa_start=1, swa_eval_freq=5,callbacks=[tb_logger])
# learner.save('wrn_512_unbalanced')

#learner.load('wrn_512_unbalanced-swa')


# =======================================================================================================================
# Submission
# =======================================================================================================================
models = ['wrn_512_unbalanced-swa']
#=======================================================================================================================
# Bagging
########################################################################################################################
