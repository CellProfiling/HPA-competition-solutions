...
#
# tb_logger = TensorboardLogger(learner.model, md, "res34_256_unbalanced_ext_4chn_4060", metrics_names=["precision", 'recall', 'f1'])
...
# learner.unfreeze()
#
# learner.fit(lrs / 4, 4, cycle_len=2, use_clr=(10, 20), cycle_save_name='res34_256_ext_4chn_5050_1', callbacks=[tb_logger])
# learner.fit(lrs / 4, 2, cycle_len=4, use_clr=(10, 20), cycle_save_name='res34_256_ext_4chn_5050_2', callbacks=[tb_logger])
# learner.fit(lrs / 16, 1, cycle_len=8, use_clr=(5, 20), cycle_save_name='res34_256_ext_4chn_5050_3',use_swa=True, swa_start=1, callbacks=[tb_logger])
...
models = ['res34_256_ext_4chn_5050_3_cyc_0', 'res34_256_ext_4chn_5050_3_cyc_0-swa']
#models = ['res34_256_ext_4chn_5050_3_cyc_0-swa']
#=======================================================================================================================
# Bagging
########################################################################################################################
