...
#
# tb_logger = TensorboardLogger(learner.model, md, "res18_512_unbalanced_ext_4chn_4060", metrics_names=["precision", 'recall', 'f1'])
#
# lr = 2e-2
# # learner.fit(lr,1)
#
...
# learner.fit(lrs / 4, 4, cycle_len=2, use_clr=(10, 20), cycle_save_name='res18_512_ext_4chn_4060_1', callbacks=[tb_logger])
# learner.fit(lrs / 4, 2, cycle_len=4, use_clr=(10, 20), cycle_save_name='res18_512_ext_4chn_4060_2', callbacks=[tb_logger])
# learner.fit(lrs / 16, 1, cycle_len=8, use_clr=(5, 20), cycle_save_name='res18_512_ext_4chn_4060_3',use_swa=True, swa_start=1, callbacks=[tb_logger])


# =======================================================================================================================
# Submission
# =======================================================================================================================
models = ['res18_512_ext_4chn_5050_3_cyc_0', 'res18_512_ext_4chn_5050_3_cyc_0-swa']
#=======================================================================================================================
# Bagging
########################################################################################################################
...
for imodel in models:
    ...
    #     clf = RidgeClassifierCV(alphas=[ 0.001, 0.01, 0.1, 1],class_weight={0:1, 1:wt}).fit(pred,b ) #
    ...
    # clf26 = ridge(y, pred, 26, 8)   #1.17   -0.10/6 -0.04/8
