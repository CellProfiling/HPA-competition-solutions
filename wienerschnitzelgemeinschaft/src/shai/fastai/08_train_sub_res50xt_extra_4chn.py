...
# tb_logger = TensorboardLogger(learner.model, md, "resxt50_512_unbalanced_ext", metrics_names=["precision", 'recall', 'f1'])
# lr = 1e-3
# lrs = np.array([lr / 10, lr / 3, lr])
# =======================================================================================================================
...
#learner.fit(lrs / 4, 4, cycle_len=2, use_clr=(10, 20), cycle_save_name='resxt50_512_ext_1', callbacks=[tb_logger])
#learner.fit(lrs / 4, 2, cycle_len=4, use_clr=(10, 20), cycle_save_name='resxt50_512_ext_2', callbacks=[tb_logger])
#learner.fit(lrs / 16, 1, cycle_len=8, use_clr=(5, 20), cycle_save_name='resxt50_512_ext_3', callbacks=[tb_logger])

#learner.save('resxt50_512_unbalanced_ext')
...
#=======================================================================================================================
# learner.load('resxt50_512_ext_2_cyc_1')
# learner.load('resxt50_512_ext_3_cyc_0')
# learner.load('resxt50_512_ext_4_cyc_0-swa')

#=======================================================================================================================
models = ['resxt50_512_ext_2_cyc_1_cp1', 'resxt50_512_ext_3_cyc_0_cp2', 'resxt50_512_ext_4_cyc_0-swa_cp3']
