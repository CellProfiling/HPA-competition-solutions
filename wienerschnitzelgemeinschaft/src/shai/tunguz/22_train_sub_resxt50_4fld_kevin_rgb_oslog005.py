...
# =======================================================================================================================
fold = 0   # specify
archt = 'resxt50_os005' # specify for output folder creation
SUB_DIR = 'subs/' + archt
...
class Oversampling:
    def __init__(self,path):
        ...
        #set the minimum number of duplicates for each class (log scale with mu = 0.05)
        self.multi = [1, 1, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1, 1, \
			2, 1, 5, 2, 3, 1, 1, 3, 1, 1, 1, 3, 1, 2, 4]
...
learner.fit(lr,1,cycle_save_name='resxt50_512_oslog005_3chn_5050_0') #(Kevin)
...
#(Kevin 2019_0101)
learner.fit(lrs , 2, cycle_len=1, cycle_mult=2, use_clr=(20,10), cycle_save_name='resxt50_512_oslog005_3chn_5050_1', callbacks=[tb_logger])
learner.fit(lrs / 4, 1, cycle_len=4, use_clr=(20, 10), cycle_save_name='resxt50_512_oslog005_3chn_5050_2', callbacks=[tb_logger])
learner.fit(lrs / 16, 1, cycle_len=4, use_clr=(10, 20), cycle_save_name='resxt50_512_oslog005_3chn_5050_3', callbacks=[tb_logger])
learner.fit(lrs / 64, 1, cycle_len=1, use_clr=(10, 20), cycle_save_name='resxt50_512_oslog005_3chn_5050_4', callbacks=[tb_logger])
#learner.fit(lrs / 256, 1, cycle_len=1, use_clr=(10, 20), cycle_save_name='resxt50_512_ovlog005_3chn_5050_5', callbacks=[tb_logger])
learner.save('resxt50_512_oslog005_3chn_fld{}'.format(fold))
