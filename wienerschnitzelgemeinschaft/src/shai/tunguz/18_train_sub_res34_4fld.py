...
# =======================================================================================================================
fold = 0   # specify
archt = 'res34' # specify for output folder creation
SUB_DIR = 'subs/' + archt
...
tb_logger = TensorboardLogger(learner.model, md, "res34_512_fold{}".format(fold), metrics_names=["precision", 'recall', 'f1'])
...
learner.fit(lrs / 16, 1, cycle_len=8, use_clr=(5, 20), cycle_save_name='res34_512_ext_4chn_5050_3', callbacks=[tb_logger])
learner.save('res34_512_fld{}'.format(fold))
