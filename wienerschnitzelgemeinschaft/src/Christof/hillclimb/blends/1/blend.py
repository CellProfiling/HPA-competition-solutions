...
MODEL_PATH = 'Christof/hillclimb/blends/1/'
nfold = 5
...
models = ['GAPNet_13_512crop','GAPNet_13_ext','GAPNet_13_ext_rgby','GAPNet_13_ext6040','ResNet34_27_ext','ResNet34_30']


model_paths = ['GAPNet/13_ext_512crop/','GAPNet/13_ext/','GAPNet/13_ext_rgby/','GAPNet/13_ext_60_40/']
...
weights = np.array([8,5,5,1,3,1,1,3])
...
sub2 = pd.read_csv('Christof/hillclimb/blends/1/submission_hc.csv')
