...
MODEL_PATH = 'Christof/models/SEGAPNet/DenseNet121/1/'
SIZE = 256
fold_id = 0
...
from keras.layers import  GlobalAveragePooling2D, Concatenate, Reshape, Permute, multiply
import keras
...
def encoder(backbone):
    ...
    c2 = backbone.get_layer('pool2_conv').output  # 63
    #c2 = ZeroPadding2D(((1, 0), (1, 0)),name='zero_padding2d_c2')(c2)  # 64
    c3 = backbone.get_layer('pool3_conv').output  # 32
    c4 = backbone.get_layer('pool4_conv').output  # 16
