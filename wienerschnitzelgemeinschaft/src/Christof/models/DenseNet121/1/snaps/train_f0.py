...
MODEL_PATH = 'Christof/models/DenseNet121/1_ss/'
SIZE = 256
fold_id = 0
...
ss = SnapshotCallbackBuilder(epochs,nb_snapshots=3,init_lr=0.0002, model_path=MODEL_PATH,model_prefix=f'model_f{fold_id}').get_callbacks()
...
model.load_weights('Christof/models/DenseNet121/1/model_f0_e100.h5')
model.fit_generator(
    train_generator,
...
model.save_weights(MODEL_PATH + 'model_f{}_e{}.h5'.format(fold_id,epochs + 100))
