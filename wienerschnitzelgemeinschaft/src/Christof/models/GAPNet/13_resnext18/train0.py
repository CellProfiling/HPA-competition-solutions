...
from classification_models.resnext.models import ResNeXt18
#from classification_models.resnet.models import ResNet18
import albumentations as A

MODEL_PATH = 'Christof/models/GAPNet/13_resnext18/'
exp_suffix = '_0'
...
def encoder(backbone):
    ...
    c0 = backbone.get_layer('stage2_unit1_relu1').output #256

    c1 = backbone.get_layer('stage3_unit1_relu1').get_output_at(0)  # 128
    c2 = backbone.get_layer('stage4_unit1_relu1').output  # 64
    enc_out = backbone.get_layer('stage4_unit2_relu').output  # 32
...
def create_model(input_shape, n_out):
    ...
    base_model = ResNeXt18(include_top=False,
                             weights=None,
