...
MODEL_PATH = 'Christof/models/GAPNet/13_ext_1024/'
...
path_to_train_ext1 = 'Christof/assets/ext_tomomi_rgb_1024/'
...
#
# outs = []
# for item in tqdm(train_dataset_info_ext1):
#     try:
#         image = data_generator.load_image(item['path'], '')
#         image = data_generator.augment(normal_aug_ext, image)
#     except:
#         outs += [item]
