...
MODEL_PATH = 'Christof/models/GAPNet/8/'
exp_suffix = '_base'
...
def create_model(input_shape, n_out):
    ...
    x0 = NoisyAndPooling2D()(squeeze_excite_block(enc_out))
    x1 = NoisyAndPooling2D()(squeeze_excite_block(short_cuts[0]))
    x2 = NoisyAndPooling2D()(squeeze_excite_block(short_cuts[1]))
...
sub2 = pd.read_csv('Christof/models/GAPNet/5/submission_loss_base_lb_dist_adjusted_8tta.csv')
f1_sub(best_sub,sub2)
