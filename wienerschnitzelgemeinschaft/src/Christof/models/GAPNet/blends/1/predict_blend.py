...
MODEL_PATH = 'Christof/models/GAPNet/blends/1/'
...
submit.to_csv(MODEL_PATH + 'submission_loss_rgb_rgby_mean.csv', index=False)

from Christof.utils import f1_sub

best_sub = pd.read_csv('ens56d.csv')
a = pd.read_csv(MODEL_PATH + 'submission_loss_rgb_rgby_mean.csv')
f1_sub(best_sub,a)
