...
MODEL_PATH = 'Christof/models/GAPNet/12_ext/'
...
model.load_weights(MODEL_PATH + 'model_loss_b.h5')
model.fit_generator(
    train_generator,
...
submit2 = pd.read_csv(MODEL_PATH + 'submission_loss_b_lb_dist_adjusted_8tta.csv')
