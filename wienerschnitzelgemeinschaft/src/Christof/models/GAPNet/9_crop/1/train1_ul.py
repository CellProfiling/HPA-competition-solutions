...
# Load dataset info
path_to_train = 'Christof/assets/train_rgb_256_ul/'
...
path_to_train_ext1 = 'Christof/assets/ext_tomomi_rgb_256_ul/'
...
for i, name in tqdm(enumerate(submit['Id'])):
    path = os.path.join('Christof/assets/test_rgb_256_ul/', name)
