...
tile = 'ur'
exp_suffix = f'_{tile}'
path_to_train = f'Christof/assets/train_rgb_512_9crop/{tile}/'
...
path_to_train_ext1 = f'Christof/assets/ext_tomomi_rgb_512_9crop/{tile}/'
...
for i, name in tqdm(enumerate(submit['Id'])):
    path = os.path.join(f'Christof/assets/test_rgb_512_9crop/{tile}/', name)
