...
MODEL_PATH = 'Christof/models/GAPNet/squeezenet/'
...
def encoder(backbone):
    ...
    c0 = backbone.get_layer('relu_conv1').output

    c1 = backbone.get_layer('fire3/concat').get_output_at(0)  # 128
    c2 = backbone.get_layer('fire5/concat').output  # 63
    #c3 = backbone.get_layer('stage4_unit1_relu1').output  # 32
    enc_out = backbone.get_layer('fire9/concat').output  # 16
