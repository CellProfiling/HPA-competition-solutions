...
oof3 = pd.read_csv(MODEL_PATH + 'oof_pred_mm.csv')
oof4 = pd.read_csv(MODEL_PATH + 'oof_pred_bl.csv')
oof5 = pd.read_csv(MODEL_PATH + 'oof_pred_br.csv')
...
for tr_ind, val_ind in kf.split(X,y,):
    ...
    m.save(MODEL_PATH + f'stacker{s_id}_stats.hdf5')
