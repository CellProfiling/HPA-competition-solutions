...
submit.to_csv(MODEL_PATH + 'submission_5crop_stacked_650_freq.csv', index=False)
...
submit3.to_csv(MODEL_PATH + 'GAPNET blend_13_ext6040_13_ext5crop_stacked_650_freq.csv', index=False)
