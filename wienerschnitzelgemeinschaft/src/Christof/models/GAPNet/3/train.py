...
MODEL_PATH = 'Christof/models/GAPNet/3/'
exp_suffix = '_base'
...
def create_model(input_shape, n_out):
    ...
    x0 = NoisyAndPooling2D()(enc_out)
    x1 = NoisyAndPooling2D()(short_cuts[0])
    x2 = NoisyAndPooling2D()(short_cuts[1])
...
model.save(MODEL_PATH + f'model{exp_suffix}_e{epochs[0]}.hdf5')
