...
MODEL_PATH = 'Christof/models/KAISA/1/'
...
from keras.layers import Reshape, Permute, multiply, MaxPool2D

from keras.layers import BatchNormalization, Lambda, Add
def create_model(input_shape, n_out):
    ...
    r = Conv2D(64,kernel_size=(5,5),activation='relu',padding='same')(r)
    g = Conv2D(64, kernel_size=(5, 5), activation='relu',padding='same')(g)
    b = Conv2D(64, kernel_size=(5, 5), activation='relu',padding='same')(b)

    r = MaxPool2D()(r)
    g = MaxPool2D()(g)
    b = MaxPool2D()(b)

    r = Conv2D(128, kernel_size=(3, 3), activation='relu',padding='same')(r)
    g = Conv2D(128, kernel_size=(3, 3), activation='relu',padding='same')(g)
    b = Conv2D(128, kernel_size=(3, 3), activation='relu',padding='same')(b)

    r = MaxPool2D()(r)
    g = MaxPool2D()(g)
    b = MaxPool2D()(b)

    r = Conv2D(256, kernel_size=(3, 3), activation='relu',padding='same')(r)
    g = Conv2D(256, kernel_size=(3, 3), activation='relu',padding='same')(g)
    b = Conv2D(256, kernel_size=(3, 3), activation='relu',padding='same')(b)
    ...
    rgb = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='same')(rgb)
    rgb = MaxPool2D()(rgb)

    rgb = Conv2D(28, kernel_size=(3, 3), activation='sigmoid', padding='same')(rgb)
...
np.save(MODEL_PATH + f'pred{fold_id}.npy',draw_predict)
