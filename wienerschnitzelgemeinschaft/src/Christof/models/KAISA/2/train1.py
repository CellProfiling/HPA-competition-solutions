...
MODEL_PATH = 'Christof/models/KAISA/2/'
...
from keras.layers import Reshape, Permute, multiply, MaxPool2D, RepeatVector
...
def create_model(input_shape, n_out):
    ...
    r_base = ResNet18(include_top=False,
                             weights='imagenet',
                             input_shape=(SIZE, SIZE, 3),input_tensor=r)
    ...
    g_base = ResNet18(include_top=False,
                             weights='imagenet',
                             input_shape=(SIZE, SIZE, 3),input_tensor=g)
    ...
    b_base = ResNet18(include_top=False,
                             weights='imagenet',
                             input_shape=(SIZE, SIZE, 3),input_tensor=b)
