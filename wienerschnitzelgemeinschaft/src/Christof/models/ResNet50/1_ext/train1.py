...
from classification_models.resnet.models import ResNet50
import albumentations as A

MODEL_PATH = 'Christof/models/ResNet50/1_ext/'
exp_suffix = '_1'
...
def create_model(input_shape, n_out):
    ...
    x = base_model.get_layer('stage4_unit1_relu2').output
...
dp = (draw_predict + draw_predict_map32) / 2
pred = dp.copy()
thresholds = np.linspace(0.95, 0.05, 101)
for j in tqdm(range(pred.shape[1])):
    for t in thresholds:
