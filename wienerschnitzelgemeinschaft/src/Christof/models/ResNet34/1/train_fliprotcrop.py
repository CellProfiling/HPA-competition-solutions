...
MODEL_PATH = 'Christof/models/ResNet34/1/'
exp_suffix = '2'
...
train_generator = data_generator.create_train(train_dataset_info[train_indexes],
                                              batch_size, (SIZE, SIZE, 3), augument=True, oversample_factor=2)
...
model.save_weights(MODEL_PATH + 'model_{}_{}.h5'.format(exp_suffix,epochs[1]))
