...
submit.to_csv(MODEL_PATH + 'submission_loss_4fold.csv', index=False)
...
sub2 = pd.read_csv('Christof/models/ResNet34/27_ext/submission_loss_5fold_mean_2.csv')
