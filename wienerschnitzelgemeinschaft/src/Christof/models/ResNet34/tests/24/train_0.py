...
def create_model(input_shape, n_out):
    ...
    x = Add()([red_base_model(Concatenate(axis = -1)([red,red,red])),green_base_model(Concatenate(axis = -1)([green,green,green])),blue_base_model(Concatenate(axis = -1)([blue,blue,blue]))])
