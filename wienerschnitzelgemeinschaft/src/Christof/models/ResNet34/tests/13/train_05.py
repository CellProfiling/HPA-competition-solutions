...
MODEL_PATH = 'Christof/models/ResNet34/tests/13/'
exp_suffix = '1'

SIZE = 256

# Load dataset info
path_to_train = 'Christof/assets/train_256_2/'
...
rare_classes = np.where( counts < 100 )
...
class data_generator:
    ...
    @staticmethod
    def create_train(dataset_info, batch_size, shape, augument=True, heavy_augment=True):
        assert shape[2] == 3
        while True:
