...
MODEL_PATH = 'Christof/models/ResNet34/tests/23/'
exp_suffix = '0'
...
import keras
from keras.layers import Cropping2D, UpSampling2D, Concatenate, MaxPooling1D, Average
...
def create_model(input_shape, n_out):
    ...
    x = Concatenate()([up_left_out,up_right_out,mid_out,bot_left_out,bot_right_out])
    x = Dropout(0.5)(x)
    x = Dense(256, activation='relu')(x)
    x = Dropout(0.5)(x)
