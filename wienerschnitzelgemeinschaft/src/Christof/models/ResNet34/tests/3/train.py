...
MODEL_PATH = 'models/ResNet34/tests/3/'
SIZE = 256
...
epochs = [2,30]
batch_size = 16
checkpoint = ModelCheckpoint(MODEL_PATH + 'model_by_f1.h5', monitor='val_f1', verbose=1,
...
model.load_weights(MODEL_PATH + 'model_by_f1.h5')
...
if CREATE_SUBMIT:
    ...
    submit.to_csv(MODEL_PATH + 'debug_submission_{:.4}.csv'.format(f1_res), index=False)