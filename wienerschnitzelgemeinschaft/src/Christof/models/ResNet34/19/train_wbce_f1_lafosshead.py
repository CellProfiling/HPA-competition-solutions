...
exp_suffix = 'wbce_brianf1_lfhead'
...
from keras.layers import Activation, Dropout, Flatten, Dense, GlobalMaxPooling2D, BatchNormalization, Input, Conv2D, Concatenate, GlobalAveragePooling2D
...
checkpoint2 = ModelCheckpoint(MODEL_PATH + 'model{}.h5'.format(exp_suffix), monitor='val_loss', verbose=1,
