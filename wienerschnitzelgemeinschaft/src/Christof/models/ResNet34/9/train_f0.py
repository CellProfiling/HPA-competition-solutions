...
def focal_loss_c(gamma=2., alpha=.25):
...
def focal_loss_b(gamma=2., alpha=.25):
    def focal_loss_fixed(y_true, y_pred):
        #y_true = K.round(K.sigmoid(logits))
...
#    return KerasFocalLoss(y_true,y_pred) + f1_logit_loss(y_true,y_pred)
