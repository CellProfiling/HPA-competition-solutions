...
MODEL_PATH = 'Christof/models/MCNN/4/'
...
from keras.layers import MaxPool2D, BatchNormalization, Add, AvgPool2D


def identity_block(input_tensor,filters = 32):
...
def down_sample(inp, reps, filters = 16):
    x = inp
    for _ in reps:
        x = Conv2D(filters, kernel_size=(3, 3), activation='relu', strides=2)(x)
    return x
...
def create_model(input_shape, n_out):
    ...
    #x0 = MaxPool2D(2)(input_tensor) #256
    #x1 = MaxPool2D(4)(input_tensor) #128
    #x2 = MaxPool2D(8)(input_tensor) #64
    #x3 = MaxPool2D(16)(input_tensor) #32
    #x4 = MaxPool2D(32)(input_tensor) #16

    x0 = Conv2D(16, kernel_size=(3, 3), activation='relu', strides=2)(input_tensor)
    x1 = Conv2D(16, kernel_size=(3, 3), activation='relu', strides=2)(x0)
    x2 = Conv2D(16, kernel_size=(3, 3), activation='relu', strides=2)(x1)
    x3 = Conv2D(16, kernel_size=(3, 3), activation='relu', strides=2)(x2)
    x4 = Conv2D(16, kernel_size=(3, 3), activation='relu', strides=2)(x3)
