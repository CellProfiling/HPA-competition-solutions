...
MODEL_PATH = 'Christof/models/MCNN/1/'
exp_suffix = '_0'
...
def identity_block(input_tensor,filters = 16):
...
def create_model(input_shape, n_out):
    ...
    x0 = MaxPool2D(2)(input_tensor)
    x1 = MaxPool2D(4)(input_tensor)
    x2 = MaxPool2D(8)(input_tensor)
    x3 = MaxPool2D(16)(input_tensor)
    x4 = MaxPool2D(32)(input_tensor)
