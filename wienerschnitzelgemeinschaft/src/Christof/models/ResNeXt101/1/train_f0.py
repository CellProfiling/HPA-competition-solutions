...
from classification_models.resnext.models import ResNeXt101
from classification_models.resnext import preprocess_input
#from keras.applications.xception import Xception, preprocess_input

MODEL_PATH = 'Christof/models/ResNeXt101/1/'
SIZE = 256
fold_id = 0
