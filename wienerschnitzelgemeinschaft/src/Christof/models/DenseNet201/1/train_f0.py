...
MODEL_PATH = 'Christof/models/DenseNet201/1/'
SIZE = 256
fold_id = 0
...
def encoder(backbone):
    ...
    offset = 0
    inp = backbone.input
    c1 = backbone.layers[4 + offset].output  # 128
    c2 = backbone.layers[51 + offset].output  # 63
    # c2 = ZeroPadding2D(((1, 0), (1, 0)),name='zero_padding2d_c2')(c2)  # 64
    c3 = backbone.layers[139 + offset].output  # 32
    c4 = backbone.layers[479 + offset].output  # 16
