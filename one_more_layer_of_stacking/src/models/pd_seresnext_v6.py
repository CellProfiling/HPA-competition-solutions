...
def pd_seresnext_v6():
    ...
    tfms = get_transforms(do_flip=True, flip_vert=True, max_rotate=180.0,
                          max_zoom=1.25, max_lighting=0.2, max_warp=None,
    ...
    data = ImageDataBunch.create(train_ds, valid_ds, test_ds, path=data_dir, device=device,
                                 size=512, bs=14, ds_tfms=tfms, padding_mode='zeros')
    ...
    learner.save('pd_seresnext_v6-stage-2')
    ...
    lr = 5e-5
    learner.fit_one_cycle(8, max_lr=get_lrs(lr, base=8))
